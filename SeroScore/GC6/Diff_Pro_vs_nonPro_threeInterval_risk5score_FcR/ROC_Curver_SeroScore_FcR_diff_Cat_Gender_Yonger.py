...
Data_Sex = pandas.read_csv('Progressor_Allmonths_Test/Sex_cat.csv', index_col = 0)
...
Age_index = np.where(Data_Age['x'] == 0)[0]


K_folder = 5
################################################## Create the folder
root = "SeroScore_ROC_Lasso_Difference_AdolescentNon_Male"
