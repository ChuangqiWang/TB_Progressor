...
Data_Group = pandas.read_csv('Progressor_Allmonths_Test/Data_group.csv', index_col=0)
Data_Age = pandas.read_csv('Progressor_Allmonths_Test/Age_cat_threshold_Adolescent.csv', index_col = 0)
Temp_index = np.where(Data_Age['x'] == 0)[0]


K_folder = 5
################################################## Create the folder
root = "SeroScore_ROC_Lasso_Difference_Non_Adolescent"
