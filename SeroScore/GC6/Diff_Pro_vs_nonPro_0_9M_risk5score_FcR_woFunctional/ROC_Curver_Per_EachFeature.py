...
## Load the data
Data_Sero_RiskScore6 = pandas.read_csv('Progressor_0_9months/Data_combining.csv',index_col=0)
Data_Group = pandas.read_csv('Progressor_0_9months/Data_group.csv',index_col=0)
