...
```{r}
#Load the meanAUC
folder <- "../Diff_Pro_vs_nonPro_threeInterval_18_27M_FcR_woFunctional"
...
```{r}
#Load the seroScore
folder <- "../Diff_Pro_vs_nonPro_threeInterval_18_27M_FcR_woFunctional/SeroScore_FcR_Lasso"
seroScore <- readRDS(file.path(folder, 'SeroScore.RDS'))
seroScore.interested <- seroScore[, index]

#Load the datatype.
#Data a folder to save the results.
output_dir <- "../Diff_Pro_vs_nonPro_threeInterval_18_27M_FcR_woFunctional/Progressor_18_27months"
