...
Data_Age = pandas.read_csv('./Progressor_9_18months_NewAge/Age_cat_threshold_Adolescent.csv', index_col = 0)
#Temp_index = np.where(Data_Age['x'] == 1)[0]

Data_Sero_RiskScore6 = Data_Sero_RiskScore6[Data_Age['x'] == 0]
Data_Group  = Data_Group[Data_Age['x'] == 0]

K_folder = 5
################################################## Create the folder
root = "SeroScore_ROC_Lasso_AdolescentNon"
