...
Data_Group = Data_Group.loc[~np.isnan(Data_Sero_RiskScore6['UnifiedScore'])]
Data_Sero_RiskScore6 = Data_Sero_RiskScore6.loc[~np.isnan(Data_Sero_RiskScore6['UnifiedScore'])]

K_folder = 5
################################################## Create the folder
root = "SeroScore_ROC_Lasso_wRisk6"
