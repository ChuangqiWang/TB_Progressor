...
saved.dir <- 'Progressor_18_27months_Correlation_Analysis'
...
selected_features <- c("IgG2_ESAT6", "FcgR2A_Ag85 AB", "FcgR2B_PPD",
                       "ADNP_PPD", "IgA1_Ag85", "ADNP_LAM")
...
pltGraph <- ggraph(graph = layout, res = 300) +
  ...
  geom_node_text(aes(label = name), size = 2, colour = "black", repel = TRUE, point.padding = unit(0.5, "lines"), check_overlap = TRUE) +
