...
```{r}
folder <- "../2021-10-25-Extract_Dataset_0-9M"

Progressor <- readRDS(file.path(paste0(folder, "/Progressor_9months_v2"), "logscale.TB.Progressor.RDS"))
Progressor.metadata <- readRDS(file.path(paste0(folder, "/Progressor_9months_v2"), "meta.data.Progressor.RDS"))
...
output_dir <- 'Progressor_0_9months_NewAge'
