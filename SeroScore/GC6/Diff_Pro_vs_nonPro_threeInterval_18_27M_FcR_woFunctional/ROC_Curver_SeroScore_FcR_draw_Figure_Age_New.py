...
Data_Group = pandas.read_csv('./Progressor_18_27months_Test/Data_group.csv',index_col=0)
Data_Age = pandas.read_csv('./Progressor_18_27months_NewAge/Age_cat_threshold_Adolescent.csv', index_col = 0)
#Temp_index = np.where(Data_Age['x'] == 1)[0]

Data_Sero_RiskScore6 = Data_Sero_RiskScore6[Data_Age['x'] == 1]
Data_Group  = Data_Group[Data_Age['x'] == 1]
