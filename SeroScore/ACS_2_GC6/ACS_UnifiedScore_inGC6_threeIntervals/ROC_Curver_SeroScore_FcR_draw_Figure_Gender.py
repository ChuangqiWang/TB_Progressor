...
Data_Group = pandas.read_csv('../../8_Experiments_GC6/Diff_Pro_vs_nonPro_threeInterval_risk5score_FcR/Progressor_Allmonths/Data_group.csv',index_col=0)
Data_Age = pandas.read_csv('../../8_Experiments_GC6/Diff_Pro_vs_nonPro_threeInterval_risk5score_FcR/Progressor_Allmonths_Test/Sex_cat.csv', index_col = 0)
