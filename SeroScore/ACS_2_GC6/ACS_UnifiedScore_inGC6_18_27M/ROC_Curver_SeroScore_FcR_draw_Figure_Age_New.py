...
Data_Group = pandas.read_csv('../../8_Experiments_GC6/Diff_Pro_vs_nonPro_threeInterval_18_27M_FcR_woFunctional/Progressor_18_27months_Test/Data_group.csv',index_col=0)
Data_Age = pandas.read_csv('../../8_Experiments_GC6/Diff_Pro_vs_nonPro_threeInterval_18_27M_FcR_woFunctional/Progressor_18_27months_NewAge/Age_cat_threshold_Adolescent.csv', index_col = 0)
Temp_index = np.where(Data_Age['x'] == 0)[0]

K_folder = 5
################################################## Create the folder
root = "SeroScore_ROC_Lasso_NewAge_Adolescent_Non"
...
for feature_index in [0]: #range(Data_Sero_RiskScore6.shape[1]):
    ...
    for iteration in range(50):  
        ...
        train_index = pandas.read_csv('../../8_Experiments_01-12-2022_GC6/Diff_Pro_vs_nonPro_18_27M_risk5score_FcR_woFunctional/Classification_RF_LASSO/idx_train_' + str(iteration+1) + '.csv')
