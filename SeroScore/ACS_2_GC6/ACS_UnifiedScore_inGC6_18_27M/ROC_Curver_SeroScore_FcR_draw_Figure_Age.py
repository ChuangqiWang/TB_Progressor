...
Data_Age = pandas.read_csv('../../8_Experiments_GC6/Diff_Pro_vs_nonPro_threeInterval_18_27M_FcR_woFunctional/Progressor_18_27months_Test/Age_cat_threshold_Adolescent.csv', index_col = 0)
Temp_index = np.where(Data_Age['x'] == 0)[0]

K_folder = 5
################################################## Create the folder
root = "SeroScore_ROC_Lasso_Age_Adolescent_Non"
