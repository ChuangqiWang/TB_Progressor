...
Data_Group = pandas.read_csv('../../8_Experiments_GC6/Diff_Pro_vs_nonPro_0_9M_risk5score_FcR_woFunctional/Progressor_0_9months/Data_group.csv',index_col=0)
Data_Age = pandas.read_csv('../../8_Experiments_GC6/Diff_Pro_vs_nonPro_threeInterval_0_9M_FcR_woFunctional/Progressor_0_9months_NewAge/Age_cat_threshold_Adolescent.csv', index_col = 0)
...
for feature_index in [0]: #range(Data_Sero_RiskScore6.shape[1]):
    ...
    for iteration in range(50):  
        ...
        train_index = pandas.read_csv('../../8_Experiments_01-12-2022_GC6/Diff_Pro_vs_nonPro_0_9M_risk5score_FcR_woFunctional/Classification_RF_LASSO/idx_train_' + str(iteration+1) + '.csv')
    ...
    plt.savefig(os.path.join(directory, sel_features_saved + '.Sero.Data.LassoFeatures.HyperParameters_MoreSample_STD_V4.pdf'), format="pdf", bbox_inches="tight")
