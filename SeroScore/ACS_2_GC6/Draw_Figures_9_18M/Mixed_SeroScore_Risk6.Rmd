...
```{r}
#Load the meanAUC
folder <- "../ACS_UnifiedScore_inGC6_9_18M"
...
```{r}
#Load the seroScore
folder <- "../ACS_UnifiedScore_inGC6_9_18M/SeroScore_FcR_Lasso"
seroScore <- readRDS(file.path(folder, 'SeroScore.RDS'))
seroScore.interested <- seroScore[, index]

#Load the datatype.
#Data a folder to save the results.
output_dir <- '../../8_Experiments_GC6/Diff_Pro_vs_nonPro_9_18M_risk5score_FcR_woFunctional/Progressor_9_18months'
