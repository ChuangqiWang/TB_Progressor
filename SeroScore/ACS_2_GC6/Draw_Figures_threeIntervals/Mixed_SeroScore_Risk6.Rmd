...
```{r}
#Load the meanAUC
folder <- "../ACS_UnifiedScore_inGC6_threeIntervals"
...
```{r}
#Load the seroScore
folder <- "../ACS_UnifiedScore_inGC6_threeIntervals/SeroScore_FcR_Lasso"
seroScore <- readRDS(file.path(folder, 'SeroScore.RDS'))
seroScore.interested <- seroScore[, index]

#Load the datatype.
#Data a folder to save the results.
output_dir <- '../../8_Experiments_GC6/Diff_Pro_vs_nonPro_threeInterval_risk5score_FcR/Progressor_Allmonths'
