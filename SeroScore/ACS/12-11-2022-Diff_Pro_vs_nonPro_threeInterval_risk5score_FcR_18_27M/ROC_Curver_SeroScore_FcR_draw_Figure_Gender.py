...
Data_Group = pandas.read_csv('../12-15-2022-Diff_Pro_vs_nonPro_18_27M_risk5score_FcR_woFunctional/Progressor_18_27months_New/Data_group.csv',index_col=0)
Data_Age = pandas.read_csv('../12-15-2022-Diff_Pro_vs_nonPro_18_27M_risk5score_FcR_woFunctional/Progressor_18_27months_New/Sex.csv', index_col = 0)
...
for feature_index in [0]: #range(Data_Sero_RiskScore6.shape[1]):
    ...
    for iteration in range(50):  
        ...
        train_index = pandas.read_csv('../12-15-2022-Diff_Pro_vs_nonPro_18_27M_risk5score_FcR_woFunctional/Classification_RF_LASSO/idx_train_' + str(iteration+1) + '.csv')
