...
Data_Group = pandas.read_csv('../12-14-2022-Diff_Pro_vs_nonPro_9_18M_risk5score_FcR_woFunctional/Progressor_9_18months_New/Data_group.csv',index_col=0)
Data_Age = pandas.read_csv('../12-14-2022-Diff_Pro_vs_nonPro_9_18M_risk5score_FcR_woFunctional/Progressor_9_18months_New//Sex.csv', index_col = 0)
