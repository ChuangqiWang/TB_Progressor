...
```{r}
rm(list = setdiff(ls(), c("New.Data.matrix","NonProgressor.Data.matrix", "Progressor.Data.matrix", "TimetoTB.matrix", "Patient.ID.wGroup", "SystemSerogy.w.Risk6","output_dir")))
```
