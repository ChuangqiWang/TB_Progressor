...
data.df <- readRDS(file.path(folder, "Features_Freq.RDS"))

temp.df <- top_n(data.df, 19, Freq)
interested.features <- as.character(temp.df$FeatureName)
# interested.features <- c("Risk6", "IgG1_LAM", "IgG4_Ag85", "FcgR2A_PPD","FcgR3B_PPD",
#                          "IgA1_PPD", "IgG2_LAM", "IgG4_Hspx", "IgM_ESAT6", 
#                          "IgA2_Tbad", "IgG1_Hspx", "IgG1_PPD", "IgG3_CFP10")
interested.features <- gsub("\\.", " ", interested.features)
