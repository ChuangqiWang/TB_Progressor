...
Data_Group = pandas.read_csv('../11-10-2021-Diff_Pro_vs_nonPro_0_9M_risk6score_FcR/Progressor_9months_New/Data_group.csv',index_col=0)
Data_Age = pandas.read_csv('../11-10-2021-Diff_Pro_vs_nonPro_0_9M_risk6score_FcR/Progressor_9months_New//Sex.csv', index_col = 0)
...
for feature_index in [0]: #range(Data_Sero_RiskScore6.shape[1]):
    ...
    for iteration in range(50):  
        ...
        train_index = pandas.read_csv('../11-10-2021-Diff_Pro_vs_nonPro_0_9M_risk6score_FcR/Classification_RF_LASSO/idx_train_' + str(iteration+1) + '.csv')
