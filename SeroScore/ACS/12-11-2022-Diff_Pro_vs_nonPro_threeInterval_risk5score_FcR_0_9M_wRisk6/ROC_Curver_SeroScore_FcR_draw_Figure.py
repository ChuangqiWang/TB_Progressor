...
Data_Group = pandas.read_csv('../11-10-2021-Diff_Pro_vs_nonPro_0_9M_risk6score_FcR/Progressor_9months/Data_group.csv',index_col=0)
...
for feature_index in [0]: #range(Data_Sero_RiskScore6.shape[1]):
    ...
    plt.savefig(os.path.join(directory, sel_features_saved + '.Sero.Data.LassoFeatures.HyperParameters_test_Moresamples_V4.pdf'), format="pdf", bbox_inches="tight")
