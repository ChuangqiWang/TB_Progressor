...
for feature_index in range(98, Data_Sero_RiskScore6.shape[1]):
    ...
    #plt.savefig(os.path.join("PerFeatures_ROC_v2", sel_features_saved + '.Sero.Data.LassoFeatures.HyperParameters.png'))
